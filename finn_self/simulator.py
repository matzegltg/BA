...
class Simulator:
    ...
    init_conc, t_max, t_steps, x_left, x_right, x_steps, v):
        ...
        self.retardation = self.retardation_two_sorption
        self.ts_sorp = [0]
    ...
    def retardation_two_sorption(self, c, t):
        ...
        sk_sol_diff = solve_ivp(self.sk_ode, (self.ts_sorp[0], self.ts_sorp[1]), self.s_k_diff, args=(c, ), method="BDF")
