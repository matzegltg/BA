...
class Simulator(object):
    ...
    def generate_sample(self):
        ...
        # sample_c: [spatial, time steps], dissolved conc.
        # sample_sk: [spatial, time steps], kin. sorbec conc.
    ...
    def ad_ode(self, t, conc_cw_sk:np.ndarray):
        ...
        if self.sand:
            ...
            #print(self.sorpt_derivat(cw_soil))
            ...
            #print(f" cw_soil: {cw_soil}")
            #print(f" der: {self.sorpt_derivat(cw_soil)}")
            #print(f" ret: {ret}")
            #time.sleep(0.1)
